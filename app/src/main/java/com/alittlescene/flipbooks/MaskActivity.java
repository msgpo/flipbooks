...
public class MaskActivity extends ActionBarActivity implements View.OnClickListener {
    private static final String PATH = "/sdcard/temp.mp4";
    ...
    private void addTextViewToLayout(String text) {
        TextView textView = new TextView(MaskActivity.this);
        textView.setText(text);
        outputLayout.addView(textView);
    }

    private void showUnsupportedExceptionDialog() {
        new AlertDialog.Builder(MaskActivity.this)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.run_command:
                ...
                String command = "-y -i /sdcard/temp.mp4 -vf crop=720:720:0:200 -an /sdcard/tmp_out.mp4";
                if (!TextUtils.isEmpty(command)) {
                    execFFmpegBinary(command);
                } else {
                    Toast.makeText(MaskActivity.this, getString(R.string.empty_command_toast), Toast.LENGTH_LONG).show();
                }
                break;
        }
    }
